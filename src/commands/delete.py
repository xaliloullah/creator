...
class DeleteCommand(Command):
    ...
    def handle(args):
        ...
        if args.model:
            ...
            filename = f"{Creator.path.models(name)}.py"
            ...
            filename = f"{Creator.path.controllers(name)}.py"
            if Creator.file(filename).exists():
                Creator.file(filename).delete() 
            ...
            filename = f"{Creator.path.migrations(name)}.py"
            if Creator.file(filename).exists():
                Creator.file(filename).delete()
            ...
            try:  
                ...
                folder = Creator.path.storage(f"backups/{name}")
            ...
            filename = f"{Creator.path.middlewares(name)}.py"
            if Creator.file(filename).exists():
                Creator.file(filename).delete() 
