...
(function (_) {
  ...
  */
        ...
        w = function (a, b) {
            if (b)
                a: {
                    ...
                    b != d &&
                        b != null &&
                        qb(c, a, { configurable: !0, writable: !0, value: b });
                }
        };
        w("Symbol", function (a) {
            if (a) return a;
        ...
        _.y = function (a) {
            ...
            if (typeof a.length == "number") return { next: pb(a) };
        ...
        Eb =
            typeof Object.assign == "function"
                ...
                : function (a, b) {
                      for (var c = 1; c < arguments.length; c++) {
                          var d = arguments[c];
                          if (d) for (var e in d) Db(d, e) && (a[e] = d[e]);
                      }
                      return a;
                  };
        ...
        _.Aa = function (a) {
            return (
                (Object.prototype.hasOwnProperty.call(a, Nb) && a[Nb]) ||
                (a[Nb] = ++Ob)
            );
        };
        ...
        _.nc = function () {
            return (
                ...
                Math.abs(
                    Math.floor(Math.random() * 2147483648) ^ _.Sb()
                ).toString(36)
            );
        };
        var oc = !!(Jb[0] & 2048);
        ...
        _.xc =
            _.u("Gecko") &&
            !(_.Ua().toLowerCase().indexOf("webkit") != -1 && !_.u("Edge")) &&
        ...
        _.md.prototype.wf = function (a, b) {
            ...
            d
                ...
                : ((this.offsetX =
                      _.yc || a.offsetX !== void 0 ? a.offsetX : a.layerX),
                  (this.offsetY =
                      _.yc || a.offsetY !== void 0 ? a.offsetY : a.layerY),
        ...
        eb.prototype.add = function (a, b, c, d, e) {
            ...
            g > -1
                ? ((b = a[g]), c || (b.Hd = !1))
                : ((b = new qd(b, this.src, f, !!d, e)), (b.Hd = c), a.push(b));
            return b;
        };
        ...
        var sd = function (a, b, c, d) {
            for (var e = 0; e < a.length; ++e) {
                var f = a[e];
                if (!f.gd && f.listener == b && f.capture == !!c && f.be == d)
                    return e;
            }
            return -1;
        };
        ...
        _.Gd = function (a) {
            ...
            xd--;
            (c = _.Bd(b))
                ? (td(c, a), c.h == 0 && ((c.src = null), (b[vd] = null)))
                : rd(a);
            return !0;
        };
        Dd = function (a) {
        ...
        _.k.dispatchEvent = function (a) {
            ...
            a.fd ||
                ...
                a.fd || (e = Id(g, d, !1, a) && e));
            if (b)
                for (f = 0; !a.fd && f < b.length; f++)
                    (g = a.currentTarget = b[f]), (e = Id(g, d, !1, a) && e);
            return e;
        };
        _.k.I = function () {
            _.G.O.I.call(this);
        ...
        _.be.prototype.then = function (a, b, c) {
            return fe(
                this,
                Sd(typeof a === "function" ? a : null),
                Sd(typeof b === "function" ? b : null),
                c
            );
        };
  ...
  */
        ...
        var Ce = function (a) {
            ...
            ue = function (a) {
                ...
                d &&
                    ((h = (0, _.A)(a.G, a, !0)),
                    (d = (0, _.A)(a.G, a, !1)),
                    b instanceof re ? (xe(b, h, d), (b.L = !0)) : b.then(h, d));
        ...
        Kb.Sa = Fe;
        Kb.Sa.g = { tg: 0, ig: 1, TIMEOUT: 2, rg: 3, Ge: 4 };
        var He = function () {
            Rd.call(this);
            this.P = null;
            this.g = {};
        ...
        _.k.Wf = function (a, b) {
            if (!(this instanceof He)) this.Wf(a, b);
                ...
                b && b.length
                    ? (ya(this.l, b), (this.oa = b[b.length - 1]))
        ...
        var Me = function (a) {
            ...
            Je = function (a, b, c) {
                a.g[b]
                    ? ((a = a.g[b].h),
                      a != c &&
                          a.splice.apply(a, [0, a.length].concat(_.Bb(c))))
                    : (a.g[b] = new Od(c, b));
            },
            Pe = function (a, b, c) {
                var d = [];
                ...
                for (var e = {}, f = 0; f < d.length; f++) {
                    ...
                    h.g
                        ? l.callback(a.Ca)
                        : (Ne(a, g, h, !!c, l), Oe(a, g) || b.push(g));
                }
                b.length > 0 &&
                    (a.l.length === 0 ? a.M(b) : (a.h.push(b), Me(a)));
                return e;
            },
            Ne = function (a, b, c, d, e) {
            ...
            if (e.length !== 0) {
                ...
                a = (0, _.A)(this.B.G, this.B, _.xa(e), this.g, {
                    ...
                    Hf: function (f, g) {
                        ...
                        f == 401
                            ? (Re(d, new Kb.Sa(Kb.Sa.g.tg, f)),
                              (d.h.length = 0))
                            : f == 410
                            ? (Se(d, new Kb.Sa(Kb.Sa.g.rg, f)), Te(d))
                            : d.D >= 3
                            ? (Se(d, new Kb.Sa(Kb.Sa.g.ig, f, l, g)), Te(d))
                            : d.M(d.o, !0, f == 8001 || !1);
                    },
        ...
        var Qe = function (a, b) {
            ...
            Ke = function (a) {
                a.j == a.F &&
                    ((a.j = null),
                    a.F.onLoad((0, _.A)(a.Rg, a)) &&
                        Re(a, new Kb.Sa(Kb.Sa.g.Ge)),
                    Me(a));
            },
            la = function (a) {
                if (a.j) {
        ...
        He.prototype.Ph = function (a) {
            this.j ||
                ((this.g.synthetic_module_overhead = new Od(
                    [],
                ...
                if ((e = a.N.error))
                    for (f = 0; f < e.length; f++)
                        for (var g = e[f], h = 0; h < d.length; h++)
                            g("error", d[h], b);
                for (d = 0; d < c.length; d++) a.g[c[d]] && a.g[c[d]].Hf(b);
                a.o.length = 0;
                Me(a);
            },
            Te = function (a) {
        ...
        var We = [],
            Xe = function (a) {
                ...
                var c = { Wk: {}, index: We.length, Co: a };
                b(a.ye);
                b(a.h);
                We.push(c);
                a.ye &&
                    _.Yb(a.ye, function (d) {
                        var e = d.id;
        ...
        new D("amY3Td");
        new D("tLnxq");
        Xe({ ye: [{ id: _.Wb, tb: Ld, multiple: !0 }] });
        var hf;
        _.ef = RegExp(
            "^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$"
        );
        ...
        _.of.prototype.fa = function (a, b) {
            ...
            this.h(
                null,
                "function" == typeof _.pf && a instanceof _.pf ? a.Tb : null
            );
            return String(a);
        };
        ...
        xf.prototype.toString = function () {
            if (this.h.endsWith("_/wa/"))
                var a = this.h + yf(this, "wk") + this.l;
        ...
        var Af = function (a) {
            ...
            If = function (a) {
                ...
                if (d.h.endsWith("_/r/"))
                    return Bf(d, "sc", Hf(a).toString()), d;
                if (!b) return d;
    ...
    try {
        ...
        _.L[42] = "Traduction";
        _.L[43] = "Traduire";
        _.L[44] = "Votre correction a bien \u00e9t\u00e9 soumise.";
...
//# sourceURL=/_/translate_http/_/js/k=translate_http.tr.fr.KuQGj3F1Sbg.O/am=DAY/d=1/rs=AN8SPfpebCx8MbN2V6qQZaPETUTEmellZw/m=el_conf
// Configure Constants
(function () {
    ...
    (function () {
        ...
        _loadCss(c._ps);
        _loadJs(
            "https://translate.googleapis.com/_/translate_http/_/js/k\x3dtranslate_http.tr.fr.KuQGj3F1Sbg.O/am\x3dACA/d\x3d1/exm\x3del_conf/ed\x3d1/rs\x3dAN8SPfr1-BVEQ7d3LC6J27vIBqTT5GTAuA/m\x3del_main"
        );
        _exportMessages();
        _exportVersion("TE_20250209");
    })();
})();
