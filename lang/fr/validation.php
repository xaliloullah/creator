...
return [
    ...
    'after' => 'La :attribute doit être une date postérieure à :date.',
    ...
    'before' => 'La champ :attribute doit être une date antérieure à :date.',
    'before_or_equal' => 'La champ :attribute doit être une date antérieure ou égale à :date.',
    'between' => [
    ...
    'date_format' => 'La date :attribute doit correspondre au format :format.',
