...
@section('content')
    ...
    <!-- Form Card -->
    <form action="{{ route('users.store') }}" method="POST" enctype="multipart/form-data" class="validate">
        @csrf
        <div class="row">
            <div class="col-lg-8">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="form-group row g-1">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="adresse[rue]" class="form-control"
                                            value="{{ old('adresse.rue') }}">
                                    </div>

                                    <div class="col-md-6">
                                        <label class="form-label">Ville</label>
                                        <input type="text" name="adresse[ville]" class="form-control"
                                            value="{{ old('adresse.ville') }}">
                                    </div>

                                    <div class="col-md-4">
                                        <label class="form-label">Code Postal</label>
                                        <input type="text" name="adresse[code]" class="form-control"
                                            value="{{ old('adresse.code') }}">
                                    </div>

                                    <div class="col-md-4">
                                        <label class="form-label">Pays</label>
                                        <input type="text" name="adresse[pays]" class="form-control"
                                            value="{{ old('adresse.pays') }}">
                                        {{-- <select name="adresse[country]" class="form-select">
                                            <option value="">Sélectionner un pays</option>
                                            <option value="Sénégal"
                                                {{ old('adresse.country', $adresse['country'] ?? '') == 'Sénégal' ? 'selected' : '' }}>
                                                Sénégal</option>
                                            <option value="France"
                                                {{ old('adresse.country', $adresse['country'] ?? '') == 'France' ? 'selected' : '' }}>
                                                France</option>
                                            <option value="Canada"
                                                {{ old('adresse.country', $adresse['country'] ?? '') == 'Canada' ? 'selected' : '' }}>
                                                Canada</option>
                                        </select> --}}
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="adresse[complement]" class="form-control"
                                            value="{{ old('adresse.complement') }}">
                                    </div>
                                </div>
                            </div>
                        </div>
