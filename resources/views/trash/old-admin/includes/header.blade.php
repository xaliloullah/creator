...
<header class="top-navbar d-flex navbar-light bg-white bg-gradient sticky-top align-items-center px-3 shadow">
    <div class="navbar-brand d-flex align-items-center">
        ...
        <a href="{{ route('admin') }}" class="text-decoration-none text-dark">
            ...
            <span class="navbar-brand-text notranslate">ADMIN {{ config('app.name') }}</span>
        </a>
    </div>
    <div class="ms-auto d-flex align-items-center gap-3">
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow">
                ...
                <li>
                    <a class="dropdown-item text-center small text-gray-500"
                        href="{{ route('notifications.index') }}">Afficher toutes les messages</a>
                </li>
            </ul>
        </div>
        ...
        <div class="dropdown">
            <button class="btn d-flex align-items-center gap-2" type="button" data-bs-toggle="dropdown">
                ...
                <span class="d-none d-md-block ms-2">{{ auth()->user()->prenom }}
                    {{ auth()->user()->nom }}</span>
            </button>
            <ul class="dropdown-menu dropdown-menu-end shadow">
                <li>
