...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0">Details de l'client</h1>
            <p class="text-muted mb-0">Afficher les informations complètes sur l'client</p>
        </div>
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('clients.edit', $client->id) }}" class="btn btn-outline-dark">
                <i class="bi bi-pencil"></i><span class="d-none d-sm-inline ms-2">Modifier</span>
            </a>
            <a href="{{ route('clients.create') }}" class="btn btn-outline-dark">
        ...
        <div class="col-lg-8">
            <ul class="nav nav-tabs nav-fill" id="parametre" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="client-info-tab" data-bs-toggle="tab" data-bs-target="#client-info"
                        type="button" role="tab" aria-controls="client-info" aria-selected="true">Informations
                        générales</button>
                </li>
                <li class="nav-item" role="presentation">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <span class="fs-5">{{ $client->prenom }}</span>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="small text-muted d-block">Nom</label>
                                    <span class="fs-5">{{ $client->nom }}</span>
                                </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        @component('components.tags', ['badge' => $client->statut])
                                        @endcomponent
                                    </div>

                                    <div class="col-12">
                                        <label class="small text-muted d-block">Tags</label>
                                        @component('components.tags', ['tags' => $client->tags])
                                        @endcomponent
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card border-0 shadow-sm mt-3 mb-4">
                        <div class="card-body p-4">
                            {{-- <div class="mb-4">
                                ...
                                <div class="col-12 mb-3">
                                    <label class="small text-muted d-block">Roles de l'client</label>
                                    @component('components.tags', ['badges' => $client->roles])
                                    @endcomponent
                                </div>
                                <div class="col-12 mb-3">
                                    <label class="small text-muted d-block">Permissions de l'client</label>
                                    @component('components.tags', ['badges' => $client->getAllPermissions()])
                                    @endcomponent
                                </div>
                            </div> --}}
                        </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body p-4">
                    ...
                    <img src="{{ asset('assets/images/' . $client->image()) }}" alt="profil"
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body p-4">
                    ...
                    <small class="text-muted">{{ $client->updated_at }}</small>
                    {{--
                        <dl class="row mb-0">
                            <dt class="col-sm-6">Created</dt>
                            <dd class="col-sm-6 text-muted">{{ $client->created_at }}</dd>

                            <dt class="col-sm-6">Modified</dt>
                            <dd class="col-sm-6 text-muted">{{ $client->updated_at }}</dd>
                        </dl>
                            --}}
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        <img src="{{ asset('assets/images/' . ($client->image ? 'clients/' . $client->image : 'default-client.png')) }}"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <span><a href="tel:{{ $client->telephone }}">{{ $client->telephone }}</a></span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="text-secondary" for="mobile">Mobile:</label>
                        <span><a href="tel:{{ $client->mobile }}">{{ $client->mobile }}</a></span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <span><a target="_blank" href="{{ $client->site_web }}">{{ $client->site_web }}</a></span>
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="text-secondary" for="biographie">Biographie:</label>
                        <span>{!! $client->biographie !!}</span>
                    </div>
                </div>
            </div>
        </div>
