...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0">Modifier un client</h1>
            <p class="text-muted mb-0">
                Mettez à jour les informations de l'client en remplissant le formulaire ci-dessous.
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('clients.show', $client->id) }}" class="btn btn-outline-dark">
    ...
    <!-- Form Card -->
    <form action="{{ route('clients.update', $client->id) }}" method="POST" enctype="multipart/form-data" class="validate">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-lg-8">
                ...
                <div class="tab-content" id="components-content">
                    <div class="tab-pane fade show active" id="client-info" role="tabpanel"
                        aria-labelledby="client-info-tab" tabindex="0">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="prenom" name="prenom"
                                                placeholder="Prénom" value="{{ old('prenom', $client->prenom) }}"
                                                required />
                                        </div>
                                        <div class="col-md-6">
                                            <label class="form-label">Nom</label>
                                            <input type="text" class="form-control" id="nom" name="nom"
                                                placeholder="Nom" value="{{ old('nom', $client->nom) }}" />
                                        </div>
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="email" class="form-control" id="email" name="email"
                                                    placeholder="E-mail" value="{{ old('email', $client->email) }}"
                                                    required />
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control"
                                                    ...
                                                    name="adresse[rue]"
                                                    value="{{ old('adresse.rue', $client->adresse['rue']) }}">
                                                ...
                                                <input type="text" class="form-control"
                                                    ...
                                                    value="{{ old('adresse.complement', $client->adresse['complement']) }}">
                                            </div>
                                            <div class="input-group mb-3">
                                                <span class="input-group-text"><i class="bi bi-buildings"></i></span>
                                                <input type="text" class="form-control" placeholder="Ville"
                                                    id="ville" name="adresse[ville]"
                                                    value="{{ old('adresse.ville', $client->adresse['ville']) }}">
                                                <span class="input-group-text"><i class="bi bi-mailbox"></i></span>
                                                <input type="text" class="form-control" placeholder="Code Postal"
                                                    id="code_postal" name="adresse[code_postal]"
                                                    value="{{ old('adresse.code_postal', $client->adresse['code_postal']) }}">
                                                <span class="input-group-text"><i class="bi bi-globe"></i></span>
                                                <input type="text" class="form-control" placeholder="Pays"
                                                    id="pays" name="adresse[pays]"
                                                    value="{{ old('adresse.pays', $client->adresse['pays']) }}">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            ...
                                            @foreach ($statuts as $statut)
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="statut"
                                                        ...
                                                        @if (old('statut', $client->statut->value) == $statut->value) checked @endif />
                                        ...
                                        <select class="form-select tags" multiple name="roles[]">
                                            @foreach ($roles as $role)
                                                <option value="{{ $role->name }}"
                                                    @if (in_array($role->name, old('roles', $client->roles->pluck('name')->toArray()))) selected @endif>
                                        ...
                                        <select class="form-select tags" multiple name="permissions[]">
                                            @foreach ($permissions as $permission)
                                                <option value="{{ $permission->name }}"
                                                    @if (in_array($permission->name, old('permissions', $client->permissions->pluck('name')->toArray()))) selected @endif>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="text-center mb-3">
                            <div class="image-container rounded-circle img-lg">
                                ...
                                {{-- {{ asset('assets/images/' . ($client->image ? 'clients/' . $client->image : 'default-client.png')) }} --}}
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body p-4">
                        ...
                        <dl class="row mb-0">
                            ...
                            <small class="text-muted">{{ formatDateTime($client->created_at) }}</small>
                            <h6 class="mt-3 mb-0">Date de modification</h6>
                            <small class="text-muted">{{ formatDateTime($client->updated_at) }}</small>
                        </dl>
                    </div>
                </div>
