...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0">Ajouter une nouvelle produit</h1>
            <p class="text-muted mb-0">
                Remplissez le formulaire ci-dessous pour creer un produit.
    ...
    <!-- Form Card -->
    <form action="{{ route('produits.store') }}" method="POST" enctype="multipart/form-data" class="validate">
        @csrf
        <div class="row">
            <div class="col-lg-8">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <div class="text-center">
                                        <label class="form-label">Autre Images</label>
                                ...
                                <div class="col-12">
                                    <div class="mb-3 form-check">
                                        <input type="checkbox" class="form-check-input" id="new"
                                            name="parametre[new]" @if (old('parametre.new')) checked @endif>
