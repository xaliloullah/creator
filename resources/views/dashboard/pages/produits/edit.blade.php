    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0">
                Mettez à jour les informations du produit en remplissant le formulaire ci-dessous.
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('produits.show', $produit->id) }}" class="btn btn-outline-dark">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="designation" name="designation"
                                        placeholder="Désignation" value="{{ old('designation', $produit->designation) }}"
                                        required />
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <select name="menu_id" id="menu_id" class="form-control">
                                        ...
                                        @forelse ($menus as $menu)
                                            <option value="{{ $menu->id }}"
                                                @if (old('menu_id', $produit->menu_id) == $menu->id) selected @endif>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="prix" name="prix"
                                            placeholder="Prix" value="{{ old('prix', $produit->prix) }}" />
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="duree" name="duree"
                                            placeholder="Durée" value="{{ old('duree', $produit->duree) }}" />
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="reduction" name="reduction"
                                            placeholder="Réduction" value="{{ old('reduction', $produit->reduction) }}" />
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-3">
                                    ...
                                    @foreach ($statuts ?? [] as $statut)
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="statut"
                                                ...
                                                @if (old('statut', $produit->statut->value) == $statut->value) checked @endif required />
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control editor-simple" id="description" name="description" placeholder="Description">{!! old('description', $produit->description) !!}</textarea>
                                </div>
                                {{-- <div class="col-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <select class="form-select tags" multiple name="tags[]">
                                        @foreach (old('tags', $produit->tags) as $tags)
                                ...
                                <div class="col-12">
                                    <div class="mb-3 form-check">
                                        <input type="checkbox" class="form-check-input" id="new"
                                            name="parametre[new]" @if (old('parametre.new', $produit->parametre['new'] ?? false)) checked @endif>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="text-center mb-3">
                            <div class="image-container rounded-circle img-lg shadow">
                                <img src="{{ asset('assets/images/' . $produit->image()) }}" alt="image"
