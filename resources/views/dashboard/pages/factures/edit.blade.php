...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0">Modifier un facture</h1>
            <p class="text-muted mb-0">
                Mettez à jour les informations du facture en remplissant le formulaire ci-dessous.
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('factures.show', $facture->id) }}" class="btn btn-outline-dark" target="_blank">
                            ...
                            <div class="row g-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="designation" name="designation"
                                        value="{{ old('designation', $facture->designation) }}" placeholder="Désignation"
                                        required />
                                </div>
                                <div class="col-12">
                                    <label class="form-label">Catégories</label>
                                    <select class="form-select" name="facture_id">
                                        <option value="" selected disabled>Catégorie</option>
                                        @include('dashboard.modules.factures.includes.options', [
                                            'factures' => $factures,
                                            'depth' => 0,
                                        ])
                                    </select>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control editor" id="description" name="description" placeholder="Description">{!! $facture->description !!}</textarea>
                                </div>
                                <div class="col-12">
                                    <label class="form-label">Tags</label>
                                    <select class="form-select tags" multiple name="tags[]">
                                        @foreach ($facture->tags as $tag)
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="text-center mb-3">
                            <div class="image-container rounded-circle img-lg shadow">
                                <img src="{{ asset('assets/images/' . $facture->image()) }}" alt="image"
