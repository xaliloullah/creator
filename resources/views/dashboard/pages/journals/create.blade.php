...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0">Ajouter une nouvelle journal</h1>
            <p class="text-muted mb-0">
                Remplissez le formulaire ci-dessous pour creer un journal.
    ...
    <!-- Form Card -->
    <form action="{{ route('journals.store') }}" method="POST" enctype="multipart/form-data" class="validate">
        @csrf
        <div class="row">
            <div class="col-lg-8">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="recettes" name="recettes"
                                            min="0" placeholder="Recettes" value="{{ old('recettes', 0) }}" />
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="depenses" name="depenses"
                                            placeholder="Dépenses" value="{{ old('depenses', 0) }}" min="0" />
                                        <span class="input-group-text">{{ auth()->user()->parametre['devise'] }}</span>
                                    </div>
                                </div>
                                {{-- <div class="col-md-6">
