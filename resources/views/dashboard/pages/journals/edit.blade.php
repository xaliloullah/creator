...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0">Modifier un journal</h1>
            <p class="text-muted mb-0">
                Mettez à jour les informations du journal en remplissant le formulaire ci-dessous.
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('journals.show', $journal->id) }}" class="btn btn-outline-dark">
                            ...
                            <div class="row g-3">
                                <div class="col-md-3">
                                    ...
                                    <input type="date" class="form-control" id="date" name="date"
                                        placeholder="Date" value="{{ old('date', $journal->date) }}" required />
                                </div>
                                <div class="col-md-9">
                                    <label class="form-label">Désignation <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="designation" name="designation"
                                        placeholder="Désignation" value="{{ old('designation', $journal->designation) }}"
                                        required />
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Recettes</label>
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="recettes" name="recettes"
                                            placeholder="Recettes" value="{{ old('recettes', $journal->recettes) }}"
                                            min="0" />
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="depenses" name="depenses"
                                            placeholder="Dépenses" value="{{ old('depenses', $journal->depenses) }}"
                                            min="0" />
                                        <span class="input-group-text">{{ auth()->user()->parametre['devise'] }}</span>
                                    </div>
                                </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-3">
                                    ...
                                    @foreach ($statuts ?? [] as $statut)
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="statut"
                                                ...
                                                @if (old('statut', $journal->statut->value) == $statut->value) checked @endif required />
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control editor-simple" id="description" name="description" placeholder="Description">{!! old('description', $journal->description) !!}</textarea>
                                </div>
                                {{-- <div class="col-12">
                                ...
                                {{-- <div class="col-12">
                                    ...
                                    <select class="form-select tags" multiple name="tags[]">
                                        @foreach (old('tags', $journal->tags) as $tags)
                                ...
                                {{-- <div class="col-12">
                                    <div class="mb-3 form-check">
                                        <input type="checkbox" class="form-check-input" id="new" name="parametre[new]"
                                            @if (old('parametre.new', $journal->parametre['new'] ?? false)) checked @endif>
