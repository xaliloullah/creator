...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0">Mes Factures</h1>
            <p class="text-muted mb-0">Retrouvez ci-dessous tous vos factures disponibles dans l'application.</p>
        </div>
                            ...
                            <td class="no-select">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end shadow">
                                        ...
                                        <li>
                                            <a class="dropdown-item text-danger" href="#delete-facture-{{ $facture->id }}"
                                                data-bs-toggle="modal"
                                                data-bs-target="#delete-facture-{{ $facture->id }}"><i
    ...
    @foreach ($factures as $facture)
        <div class="modal fade" id="delete-facture-{{ $facture->id }}" tabindex="-1"
            ...
            @component('components.modals.delete', ['action' => route('factures.destroy', $facture->id)])
            @endcomponent
        </div>
    @endforeach
