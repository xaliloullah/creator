...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0">Details de l'employe</h1>
            <p class="text-muted mb-0">Afficher les informations complètes sur l'employe</p>
        </div>
        <div class="d-flex gap-2">
            <a href="{{ route('employes.index') }}" class="btn btn-outline-dark">
                <i class="bi bi-list-ul"></i><span class="d-none d-sm-inline ms-2">Liste</span>
            </a>
            <a href="{{ route('employes.edit', $employe->id) }}" class="btn btn-outline-dark">
        ...
        <div class="col-lg-8">
            <ul class="nav nav-tabs nav-fill" id="parametre" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="employe-info-tab" data-bs-toggle="tab"
                        data-bs-target="#employe-info" type="button" role="tab" aria-controls="employe-info"
            ...
            <div class="tab-content" id="components-content">
                <div class="tab-pane fade show active" id="employe-info" role="tabpanel" aria-labelledby="employe-info-tab"
                    tabindex="0">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        @component('components.tags', ['tags' => $employe->tags])
                                        @endcomponent
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card border-0 shadow-sm mt-3 mb-4">
                        <div class="card-body p-4">
                            {{-- <div class="mb-4">
                                ...
                                <div class="col-12 mb-3">
                                    <label class="small text-muted d-block">Roles de l'employe</label>
                                    @component('components.tags', ['badges' => $employe->roles])
                                    @endcomponent
                                </div>
                                <div class="col-12 mb-3">
                                    <label class="small text-muted d-block">Permissions de l'employe</label>
                                    @component('components.tags', ['badges' => $employe->getAllPermissions()])
                                    @endcomponent
                                </div>
                            </div> --}}
                        </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body p-4">
                    ...
                    <img src="{{ asset('assets/images/' . $employe->image()) }}" alt="profil"
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body p-4">
                    ...
                    <small class="text-muted">{{ $employe->created_at }}</small>
                    <h6 class="mt-3 mb-0">Date de modification</h6>
                    <small class="text-muted">{{ $employe->updated_at }}</small>
                    {{--
                        <dl class="row mb-0">
                            <dt class="col-sm-6">Created</dt>
                            <dd class="col-sm-6 text-muted">{{ $employe->created_at }}</dd>

                            <dt class="col-sm-6">Modified</dt>
                            <dd class="col-sm-6 text-muted">{{ $employe->updated_at }}</dd>
                        </dl>
                            --}}
                </div>
            </div>
    ...
    {{-- <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">
                Details du employe
                <a href="{{ route('employes.index') }}" class="float-right btn btn-sm btn-secondary btn-icon-split">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        <img src="{{ asset('assets/images/' . ($employe->image ? 'employes/' . $employe->image : 'default-employe.png')) }}"
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <span><a href="mailto:{{ $employe->email }}">{{ $employe->email }}</a></span>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
