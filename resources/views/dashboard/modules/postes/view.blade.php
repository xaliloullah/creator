...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0">Details de l'poste</h1>
            <p class="text-muted mb-0">Afficher les informations complètes sur le poste</p>
        </div>
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('postes.edit', $poste->id) }}" class="btn btn-outline-dark">
        ...
        <div class="col-lg-8">
            <ul class="nav nav-tabs nav-fill" id="parametre" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="poste-info-tab" data-bs-toggle="tab" data-bs-target="#poste-info"
                        type="button" role="tab" aria-controls="poste-info" aria-selected="true">Informations
                        générales</button>
                </li>
                {{-- <li class="nav-item" role="presentation">
            ...
            <div class="tab-content" id="components-content">
                <div class="tab-pane fade show active" id="poste-info" role="tabpanel" aria-labelledby="poste-info-tab"
                    tabindex="0">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <span class="fs-5">{{ $poste->designation }}</span>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="small text-muted d-block">Salaire</label>
                                    <span>{{ $poste->salaire }} {{ auth()->user()->parametre['devise'] }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        @component('components.tags', ['tags' => $poste->tags])
                                        @endcomponent
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body p-4">
                            <div class="mb-4">
                                ...
                                <div class="col-12 mb-3">
                                    <label class="small text-muted d-block">Roles de l'poste</label>
                                    @component('components.tags', ['badges' => $poste->roles])
                                    @endcomponent
                                </div>
                                <div class="col-12 mb-3">
                                    <label class="small text-muted d-block">Permissions de l'poste</label>
                                    @component('components.tags', ['badges' => $poste->getAllPermissions()])
                                    @endcomponent
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body p-4">
                    ...
                    <small class="text-muted">{{ $poste->created_at }}</small>
                    <h6 class="mt-3 mb-0">Date de modification</h6>
                    <small class="text-muted">{{ $poste->updated_at }}</small>
                    {{--
                        <dl class="row mb-0">
                            <dt class="col-sm-6">Created</dt>
                            <dd class="col-sm-6 text-muted">{{ $poste->created_at }}</dd>

                            <dt class="col-sm-6">Modified</dt>
                            <dd class="col-sm-6 text-muted">{{ $poste->updated_at }}</dd>
                        </dl>
                            --}}
                </div>
            </div>
