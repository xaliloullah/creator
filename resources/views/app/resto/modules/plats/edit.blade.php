...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0">Modifier un plat</h1>
            <p class="text-muted mb-0">
                Mettez à jour les informations du plat en remplissant le formulaire ci-dessous.
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('plats.show', $plat->id) }}" class="btn btn-outline-dark">
    ...
    <!-- Form Card -->
    <form action="{{ route('plats.update', $plat->id) }}" method="POST" enctype="multipart/form-data" class="validate">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-lg-8">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="designation" name="designation"
                                        placeholder="Désignation" value="{{ old('designation', $plat->designation) }}"
                                        required />
                                </div>
                                <div class="col-md-6">
                                    <label class="form-label">Menu</label>
                                    <select name="menu_id" id="menu_id" class="form-control">
                                        <option value="" selected disabled>Choissez un menu</option>
                                        @forelse ($menus as $menu)
                                            <option value="{{ $menu->id }}"
                                                @if (old('menu_id', $plat->menu_id) == $menu->id) selected @endif>
                                                {{ $menu->designation }}</option>
                                        @empty
                                            <option value="" disabled>Aucun menu disponible pour le moment</option>
                                        @endforelse
                                    </select>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="prix" name="prix"
                                            placeholder="Prix" value="{{ old('prix', $plat->prix) }}" />
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="duree" name="duree"
                                            placeholder="Durée" value="{{ old('duree', $plat->duree) }}" />
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="number" class="form-control" id="reduction" name="reduction"
                                            placeholder="Réduction" value="{{ old('reduction', $plat->reduction) }}" />
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-3">
                                    ...
                                    @foreach ($statuts ?? [] as $statut)
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="statut"
                                                ...
                                                @if (old('statut', $plat->statut->value) == $statut->value) checked @endif required />
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control editor-simple" id="description" name="description" placeholder="Description">{!! old('description', $plat->description) !!}</textarea>
                                </div>
                                {{-- <div class="col-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <select class="form-select tags" multiple name="tags[]">
                                        @foreach (old('tags', $plat->tags) as $tags)
                                ...
                                <div class="col-12">
                                    <div class="mb-3 form-check">
                                        <input type="checkbox" class="form-check-input" id="popular"
                                            name="parametre[popular]" @if (old('parametre.popular', $plat->parametre['popular'] ?? false)) checked @endif>
                                        <label class="form-check-label" for="popular">Marquer comme plat
                                            populaire</label>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="text-center mb-3">
                            <div class="image-container rounded-circle img-lg shadow">
                                <img src="{{ asset('assets/images/' . $plat->image) }}" alt="image"
