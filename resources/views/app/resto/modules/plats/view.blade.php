...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0">Details de l'plat</h1>
            <p class="text-muted mb-0">Afficher les informations complètes sur l'plat</p>
        </div>
        <div class="d-flex gap-2">
            <a href="{{ route('plats.index') }}" class="btn btn-outline-dark">
                <i class="bi bi-list-ul"></i><span class="d-none d-sm-inline ms-2">Liste</span>
            </a>
            <a href="{{ route('plats.edit', $plat->id) }}" class="btn btn-outline-dark">
                <i class="bi bi-pencil"></i><span class="d-none d-sm-inline ms-2">Modifier</span>
            </a>
            <a href="{{ route('plats.create') }}" class="btn btn-outline-dark">
        ...
        <div class="col-lg-8">
            <ul class="nav nav-tabs nav-fill" id="parametre" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="plat-info-tab" data-bs-toggle="tab" data-bs-target="#plat-info"
                        type="button" role="tab" aria-controls="plat-info" aria-selected="true">Informations
                        générales</button>
                </li>
                {{-- <li class="nav-item" role="presentation">
            ...
            <div class="tab-content" id="components-content">
                <div class="tab-pane fade show active" id="plat-info" role="tabpanel" aria-labelledby="plat-info-tab"
                    tabindex="0">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <span class="fs-5">{{ $plat->designation }}</span>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label class="small text-muted d-block">Menu</label>
                                    <span class="fs-5"><a href="{{ route('menus.show', $plat->Menu->id) }}">
                                            {{ $plat->Menu->designation ?? '' }}</a></span>
                                </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        @component('components.tags', ['badge' => $plat->statut])
                                        @endcomponent
                                    </div>

                                    <div class="col-12">
                                        <label class="small text-muted d-block">Tags</label>
                                        @component('components.tags', ['tags' => $plat->tags])
                                        @endcomponent
                                    </div>
                                </div>
                            </div>
                    ...
                    {{-- <div class="card border-0 shadow-sm mt-3 mb-4">
                        <div class="card-body p-4">
                            <div class="mb-4">
                                ...
                                <div class="col-12 mb-3">
                                    <label class="small text-muted d-block">Roles de l'plat</label>
                                    @component('components.tags', ['badges' => $plat->roles])
                                    @endcomponent
                                </div>
                                <div class="col-12 mb-3">
                                    <label class="small text-muted d-block">Permissions de l'plat</label>
                                    @component('components.tags', ['badges' => $plat->getAllPermissions()])
                                    @endcomponent
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body p-4">
                    ...
                    <img src="{{ asset('assets/images/' . $plat->image) }}" alt="profil"
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body p-4">
                    ...
                    <small class="text-muted">{{ $plat->created_at }}</small>
                    <h6 class="mt-3 mb-0">Date de modification</h6>
                    <small class="text-muted">{{ $plat->updated_at }}</small>
                    {{--
                        <dl class="row mb-0">
                            <dt class="col-sm-6">Created</dt>
                            <dd class="col-sm-6 text-muted">{{ $plat->created_at }}</dd>

                            <dt class="col-sm-6">Modified</dt>
                            <dd class="col-sm-6 text-muted">{{ $plat->updated_at }}</dd>
                        </dl>
                            --}}
                </div>
            </div>
