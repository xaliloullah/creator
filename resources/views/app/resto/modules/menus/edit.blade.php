...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0">Modifier un menu</h1>
            <p class="text-muted mb-0">
                Mettez à jour les informations du menu en remplissant le formulaire ci-dessous.
        ...
        <div class="d-flex gap-2">
            ...
            <a href="{{ route('menus.show', $menu->id) }}" class="btn btn-outline-dark" target="_blank">
    ...
    <!-- Form Card -->
    <form action="{{ route('menus.update', $menu->id) }}" method="POST" enctype="multipart/form-data" class="validate">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-lg-8">
                            ...
                            <div class="row g-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" id="designation" name="designation"
                                        value="{{ old('designation', $menu->designation) }}" placeholder="Désignation"
                                        required />
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-body p-4">
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group color-picker mb-4">
                                    <input type="color" class="color-input color-option shadow border-0"
                                        value="{{ old('parametre.primary', $menu->parametre['primary'] ?? '#4e73df') }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group color-picker mb-4">
                                    <input type="color" class="color-input color-option shadow border-0"
                                        value="{{ old('parametre.secondary', $menu->parametre['secondary'] ?? '#858796') }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group color-picker mb-4">
                                    <input type="color" class="color-input color-option shadow border-0"
                                        value="{{ old('parametre.background', $menu->parametre['background'] ?? '#f8f9fc') }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group color-picker mb-4">
                                    <input type="color" class="color-input color-option shadow border-0"
                                        value="{{ old('parametre.foreground', $menu->parametre['foreground'] ?? '#ffffff') }}"
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-3">
                                    ...
                                    @foreach ($statuts as $statut)
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio" name="statut"
                                                ...
                                                @if (old('statut', $menu->statut->value) == $statut->value) checked @endif required />
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control editor" id="description" name="description" placeholder="Description">{!! $menu->description !!}</textarea>
                                </div>
                                <div class="col-12">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="text-center mb-3">
                            <div class="image-container rounded-circle img-lg shadow">
                                <img src="{{ asset('assets/images/' . $menu->image) }}" alt="image"
