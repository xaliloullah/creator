...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-0">Ajouter une nouvelle menu</h1>
            <p class="text-muted mb-0">
                Remplissez le formulaire ci-dessous pour creer un menu.
    ...
    <!-- Form Card -->
    <form action="{{ route('menus.store') }}" method="POST" enctype="multipart/form-data" class="validate">
        @csrf
        <div class="row">
            <div class="col-lg-8">
                                ...
                                <div class="col-12">
                                    <div class="mb-3 form-check">
                                        <input type="checkbox" class="form-check-input" id="popular"
                                            name="parametre[popular]" @if (old('parametre.popular', $menu->parametre['popular'] ?? false)) checked @endif>
                                        <label class="form-check-label" for="popular">Marquer comme menu
                                            populaire</label>
                                    </div>
                                </div>
                            </div>
