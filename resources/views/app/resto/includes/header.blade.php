...
<header class="top-navbar d-flex navbar-light bg-white bg-gradient sticky-top align-items-center px-3 shadow">
    <div class="navbar-brand d-flex align-items-center">
        ...
        <a href="{{ route('accueil') }}" class="text-decoration-none text-dark">
    ...
    <div class="ms-auto d-flex align-items-center gap-3">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end shadow">
                    ...
                    <a class="dropdown-item d-flex align-items-center" href="">
                        <div class="dropdown-list-image mr-3">
                            <img class="rounded-circle logo" src="{{ asset('assets/images/logo.png') }}" alt="...">
                            <div class="status-indicator bg-success"></div>
                        </div>
                        <div class="font-weight-bold">
                            <div class="text-truncate text-capitalize">Notif de Khalil test</div>
                            <div class="text-truncate small text-gray-700">Lorem ipsum dolor sit amet consectetur,
                                adipisicing elit...
                            </div>
                            <div class="small text-gray-500">il y'a deux minutes</div>
                        </div>
                    </a>
                </li> --}}
                    <li>
        ...
        @endauth
        <a class="btn" data-bs-toggle="offcanvas" href="#cart" role="button" aria-controls="cart">
        ...
        @else
            <a class="btn d-flex align-items-center gap-2" href="{{ route('login') }}">
                <img src="{{ asset('assets/images/default-user.png') }}" alt="User" class="rounded-circle img-xs" />
