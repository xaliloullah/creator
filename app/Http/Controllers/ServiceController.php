...
class ServiceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('dashboard.modules.services.index', compact('services'));
    }
    ...
    {
        return view('dashboard.modules.services.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('dashboard.modules.services.view', compact('service'));
    }
    ...
    {
        $service = Service::findOrFail($id);
        return view('dashboard.modules.services.edit', compact('service'));
    }
